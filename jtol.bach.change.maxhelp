...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 518.0, 163.0, 62.0, 19.0 ],
					"style" : "",
					"text" : "bach.change",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 232.0, 262.0, 75.0, 21.0 ],
					"style" : "",
					"text" : "set ( 1 1 1 1 )",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"outlinecolor" : [ 0.494118, 0.556863, 0.607843, 1.0 ],
					"patching_rect" : [ 107.0, 375.0, 41.0, 41.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 215.0, 99.0, 21.0 ],
					"style" : "",
					"text" : "( 1 1 1 ( 1 1 1 ) 1 )",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 236.0, 199.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 79.0, 194.0, 58.0, 21.0 ],
					"style" : "",
					"text" : "( 1 1 1 1 )",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 482.0, 238.0, 29.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.0, 451.0, 61.0, 19.0 ],
					"style" : "",
					"text" : "JT Rinker",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 269.0, 147.0, 17.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 252.0, 70.0, 17.0 ],
					"style" : "",
					"text" : "@out t >> text",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 233.0, 62.0, 17.0 ],
					"style" : "",
					"text" : "__________",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 482.0, 45.0, 19.0 ],
					"style" : "",
					"text" : "onecopy",
					"textcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.0, 482.0, 180.0, 29.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 83.0, 500.0, 43.0 ],
					"style" : "",
					"text" : "jtol.bach.change will output a given III only if it is different from the stored III and will reset the stored number to that differing input III.\nThis abstraction requires the Bach library.\n",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 43.0, 164.0, 21.0 ],
					"style" : "",
					"text" : "Filter out repetitions of a III",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 13.0, 176.0, 30.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 232.0, 62.0, 17.0 ],
					"style" : "",
					"text" : "arguments :",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 430.0, 229.0, 175.0, 67.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 107.0, 304.0, 105.0, 19.0 ],
					"style" : "",
					"text" : "jtol.bach.change @out t",
					"textcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 548.0, 451.0, 60.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 431.0, 451.0, 125.0, 18.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 116.5, 365.0, 360.5, 365.0 ],
					"source" : [ "obj-1", 0 ]
				}
