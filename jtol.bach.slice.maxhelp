...
,
		"rect" : [ 379.0, 96.0, 574.0, 487.0 ],
		"bgcolor" : [ 0.278431, 0.278431, 0.278431, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 379.0, 96.0, 574.0, 487.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "( 1 1 ( 1 1 ( 2 1 ) ) )",
					"gradient" : 0,
					"patching_rect" : [ 67.0, 422.5, 237.0, 25.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-9",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 371.0, 228.333328, 122.0, 17.0 ],
					"numinlets" : 1,
					"presentation" : 0,
					"id" : "obj-7",
					"fontname" : "Arial Bold",
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"gradient" : 0,
					"patching_rect" : [ 493.0, 468.0, 238.0, 25.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-22",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "onecopy",
					"patching_rect" : [ 336.0, 468.0, 45.0, 17.0 ],
					"numinlets" : 1,
					"presentation" : 0,
					"id" : "obj-35",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"gradient" : 0,
					"patching_rect" : [ 398.0, 468.0, 180.0, 25.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-46",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 236.0, 323.0, 50.0, 17.0 ],
					"minimum" : "<none>",
					"numinlets" : 1,
					"cantchange" : 0,
					"presentation" : 0,
...
, 			{
				"box" : 				{
					...
					"gradient" : 0,
					"patching_rect" : [ 50.0, 273.0, 191.0, 15.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-18",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"gradient" : 0,
					"patching_rect" : [ 58.75, 233.0, 164.0, 15.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-37",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "( 2 ( 1 1 1 ( 1 1 1 ) ) )",
					"gradient" : 0,
					"patching_rect" : [ 54.75, 253.0, 94.0, 15.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-27",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "( 1 ( 1 1 1 ) 12 )",
					"gradient" : 0,
					"patching_rect" : [ 62.75, 213.0, 73.0, 15.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-28",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "( 1 1 1 1 )",
					"gradient" : 0,
					"patching_rect" : [ 66.75, 193.0, 49.0, 15.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-30",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "( 2 1 ( 1 2 1 ( 1 1 1 1 1 ) ) 1 )",
					"gradient" : 0,
					"patching_rect" : [ 67.0, 388.5, 237.0, 25.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-25",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"frgb" : [ 0.93, 0.93, 0.97, 1.0 ],
					"patching_rect" : [ 22.0, 81.0, 213.0, 32.0 ],
					"numinlets" : 1,
					"presentation" : 0,
					"id" : "obj-143",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"patching_rect" : [ 22.0, 13.0, 149.0, 31.0 ],
					"numinlets" : 1,
					"presentation" : 0,
					"id" : "obj-134",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jtol.bach.slice @index 3 @out t",
					"patching_rect" : [ 67.0, 350.0, 188.0, 17.0 ],
					"numinlets" : 2,
					"presentation" : 0,
					"id" : "obj-1",
					"fontname" : "Arial",
