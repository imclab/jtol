...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 212.333328, 43.0, 17.0 ],
					"style" : "",
					"text" : "percent",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 287.0, 227.333328, 50.0, 19.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 212.333328, 35.0, 17.0 ],
					"style" : "",
					"text" : "depth",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 158.0, 227.333328, 50.0, 19.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"tricolor" : [ 0.666667, 0.698039, 0.717647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 188.0, 71.0, 19.0 ],
					"style" : "",
					"text" : "( 2 ( 3 5 4 ) -1 )",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 165.5, 239.0, 19.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "jtol.bach.silencer-1 @depth 1 @percent 50 @out t",
					"textcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 87.0, 331.0, 31.0 ],
					"style" : "",
					"text" : "jtol.bach.silencer-1 removes silences in a tree at a specific depth.\nThis abstraction requires the Bach library.",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 49.0, 162.0, 21.0 ],
					"style" : "",
					"text" : "removes silences in a tree",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 19.0, 201.0, 30.0 ],
					"style" : "",
					"text" : "jtol.bach.silencer-1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "zsa_title"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jtol.bach.silencer-1.maxpat",
